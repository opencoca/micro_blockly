!function(a,t){"function"==typeof define&&define.amd?define(["./blockly_compressed.js"],t):"object"==typeof exports?module.exports=t(require("./blockly_compressed.js")):a.Blockly.JavaScript=t(a.Blockly)}(this,function(a){"use strict"
...
for(var n=0;n<t.inputList.length;n++)t.inputList[n].type==a.INPUT_VALUE&&(c=t.inputList[n].connection.targetBlock())&&(c=a.JavaScript.allNestedComments(c))&&(i+=a.JavaScript.prefixLines(c,"// "))}return t=t.nextConnection&&t.nextConnection.targetBlock(),e=e?"":a.JavaScript.blockToCode(t),i+r+e},a.JavaScript.getAdjusted=function(t,r,e,i,c){e=e||0,c=c||a.JavaScript.ORDER_NONE,t.workspace.options.oneBasedIndex&&e--
var n=t.workspace.options.oneBasedIndex?"1":"0"
if(t=e>0?a.JavaScript.valueToCode(t,r,a.JavaScript.ORDER_ADDITION)||n:0>e?a.JavaScript.valueToCode(t,r,a.JavaScript.ORDER_SUBTRACTION)||n:i?a.JavaScript.valueToCode(t,r,a.JavaScript.ORDER_UNARY_NEGATION)||n:a.JavaScript.valueToCode(t,r,c)||n,a.isNumber(t))t=+t+e,i&&(t=-t)
else{if(e>0){t=t+" + "+e
...
break
case"LAST":if("SET"==i)return t=r(),t+(e+"["+e+".length - 1] = "+n+";\n")
...
break
case"RANDOM":if(t=r(),c=a.JavaScript.variableDB_.getDistinctName("tmpX",a.VARIABLE_CATEGORY_NAME),t+="var "+c+" = Math.floor(Math.random() * "+e+".length);\n","SET"==i)return t+(e+"["+c+"] = "+n+";\n")
...
break
case"FROM_END":c=a.JavaScript.getAdjusted(t,"AT1",1,!1,a.JavaScript.ORDER_SUBTRACTION),c=r+".length - "+c
break
case"FIRST":c="0"
break
default:throw Error("Unhandled option (lists_getSublist).")}switch(i){case"FROM_START":t=a.JavaScript.getAdjusted(t,"AT2",1)
break
case"FROM_END":t=a.JavaScript.getAdjusted(t,"AT2",0,!1,a.JavaScript.ORDER_SUBTRACTION),t=r+".length - "+t
break
...
t=t.getFieldValue("TYPE")
var i=a.JavaScript.provideFunction_("listsGetSortCompare",["function "+a.JavaScript.FUNCTION_NAME_PLACEHOLDER_+"(type, direction) {","  var compareFuncs = {",'    "NUMERIC": function(a, b) {',"        return Number(a) - Number(b); },",'    "TEXT": function(a, b) {',"        return a.toString() > b.toString() ? 1 : -1; },",'    "IGNORE_CASE": function(a, b) {',"        return a.toString().toLowerCase() > b.toString().toLowerCase() ? 1 : -1; },","  };","  var compare = compareFuncs[type];","  return function(a, b) { return compare(a, b) * direction; }","}"])
return[r+".slice().sort("+i+'("'+t+'", '+e+"))",a.JavaScript.ORDER_FUNCTION_CALL]},a.JavaScript.lists_split=function(t){var r=a.JavaScript.valueToCode(t,"INPUT",a.JavaScript.ORDER_MEMBER),e=a.JavaScript.valueToCode(t,"DELIM",a.JavaScript.ORDER_NONE)||"''"
if(t=t.getFieldValue("MODE"),"SPLIT"==t)r||(r="''"),t="split"
...
a.JavaScript.STATEMENT_SUFFIX&&(c=a.JavaScript.prefixLines(a.JavaScript.injectId(a.JavaScript.STATEMENT_SUFFIX,t),a.JavaScript.INDENT)+c),e+=(r>0?" else ":"")+"if ("+i+") {\n"+c+"}",++r}while(t.getInput("IF"+r))
return(t.getInput("ELSE")||a.JavaScript.STATEMENT_SUFFIX)&&(c=a.JavaScript.statementToCode(t,"ELSE"),a.JavaScript.STATEMENT_SUFFIX&&(c=a.JavaScript.prefixLines(a.JavaScript.injectId(a.JavaScript.STATEMENT_SUFFIX,t),a.JavaScript.INDENT)+c),e+=" else {\n"+c+"}"),e+"\n"},a.JavaScript.controls_ifelse=a.JavaScript.controls_if,a.JavaScript.logic_compare=function(t){var r={EQ:"==",NEQ:"!=",LT:"<",LTE:"<=",GT:">",GTE:">="}[t.getFieldValue("OP")],e="=="==r||"!="==r?a.JavaScript.ORDER_EQUALITY:a.JavaScript.ORDER_RELATIONAL,i=a.JavaScript.valueToCode(t,"A",e)||"0"
return t=a.JavaScript.valueToCode(t,"B",e)||"0",[i+" "+r+" "+t,e]},a.JavaScript.logic_operation=function(t){var r="AND"==t.getFieldValue("OP")?"&&":"||",e="&&"==r?a.JavaScript.ORDER_LOGICAL_AND:a.JavaScript.ORDER_LOGICAL_OR,i=a.JavaScript.valueToCode(t,"A",e)
...
return["!"+(a.JavaScript.valueToCode(t,"BOOL",r)||"true"),r]},a.JavaScript.logic_boolean=function(t){return["TRUE"==t.getFieldValue("BOOL")?"true":"false",a.JavaScript.ORDER_ATOMIC]},a.JavaScript.logic_null=function(t){return["null",a.JavaScript.ORDER_ATOMIC]},a.JavaScript.logic_ternary=function(t){var r=a.JavaScript.valueToCode(t,"IF",a.JavaScript.ORDER_CONDITIONAL)||"false",e=a.JavaScript.valueToCode(t,"THEN",a.JavaScript.ORDER_CONDITIONAL)||"null"
return t=a.JavaScript.valueToCode(t,"ELSE",a.JavaScript.ORDER_CONDITIONAL)||"null",[r+" ? "+e+" : "+t,a.JavaScript.ORDER_CONDITIONAL]},a.JavaScript.loops={},a.JavaScript.controls_repeat_ext=function(t){var r=t.getField("TIMES")?+t.getFieldValue("TIMES")+"":a.JavaScript.valueToCode(t,"TIMES",a.JavaScript.ORDER_ASSIGNMENT)||"0",e=a.JavaScript.statementToCode(t,"DO")
e=a.JavaScript.addLoopTrap(e,t),t=""
var i=a.JavaScript.variableDB_.getDistinctName("count",a.VARIABLE_CATEGORY_NAME),c=r
return r.match(/^\w+$/)||a.isNumber(r)||(c=a.JavaScript.variableDB_.getDistinctName("repeat_end",a.VARIABLE_CATEGORY_NAME),t+="var "+c+" = "+r+";\n"),t+("for (var "+i+" = 0; "+i+" < "+c+"; "+i+"++) {\n"+e+"}\n")},a.JavaScript.controls_repeat=a.JavaScript.controls_repeat_ext,a.JavaScript.controls_whileUntil=function(t){var r="UNTIL"==t.getFieldValue("MODE"),e=a.JavaScript.valueToCode(t,"BOOL",r?a.JavaScript.ORDER_LOGICAL_NOT:a.JavaScript.ORDER_NONE)||"false",i=a.JavaScript.statementToCode(t,"DO")
return i=a.JavaScript.addLoopTrap(i,t),r&&(e="!"+e),"while ("+e+") {\n"+i+"}\n"},a.JavaScript.controls_for=function(t){var r=a.JavaScript.variableDB_.getName(t.getFieldValue("VAR"),a.VARIABLE_CATEGORY_NAME),e=a.JavaScript.valueToCode(t,"FROM",a.JavaScript.ORDER_ASSIGNMENT)||"0",i=a.JavaScript.valueToCode(t,"TO",a.JavaScript.ORDER_ASSIGNMENT)||"0",c=a.JavaScript.valueToCode(t,"BY",a.JavaScript.ORDER_ASSIGNMENT)||"1",n=a.JavaScript.statementToCode(t,"DO")
if(n=a.JavaScript.addLoopTrap(n,t),a.isNumber(e)&&a.isNumber(i)&&a.isNumber(c)){var v=+i>=+e
t="for ("+r+" = "+e+"; "+r+(v?" <= ":" >= ")+i+"; "+r,r=Math.abs(+c),t=(1==r?t+(v?"++":"--"):t+((v?" += ":" -= ")+r))+(") {\n"+n+"}\n")}else t="",v=e,e.match(/^\w+$/)||a.isNumber(e)||(v=a.JavaScript.variableDB_.getDistinctName(r+"_start",a.VARIABLE_CATEGORY_NAME),t+="var "+v+" = "+e+";\n"),e=i,i.match(/^\w+$/)||a.isNumber(i)||(e=a.JavaScript.variableDB_.getDistinctName(r+"_end",a.VARIABLE_CATEGORY_NAME),t+="var "+e+" = "+i+";\n"),i=a.JavaScript.variableDB_.getDistinctName(r+"_inc",a.VARIABLE_CATEGORY_NAME),t+="var "+i+" = ",t=a.isNumber(c)?t+(Math.abs(c)+";\n"):t+("Math.abs("+c+");\n"),t=t+("if ("+v+" > "+e+") {\n")+(a.JavaScript.INDENT+i+" = -"+i+";\n"),t+="}\n",t+="for ("+r+" = "+v+"; "+i+" >= 0 ? "+r+" <= "+e+" : "+r+" >= "+e+"; "+r+" += "+i+") {\n"+n+"}\n"
...
var c=e
return e.match(/^\w+$/)||(c=a.JavaScript.variableDB_.getDistinctName(r+"_list",a.VARIABLE_CATEGORY_NAME),t+="var "+c+" = "+e+";\n"),e=a.JavaScript.variableDB_.getDistinctName(r+"_index",a.VARIABLE_CATEGORY_NAME),i=a.JavaScript.INDENT+r+" = "+c+"["+e+"];\n"+i,t+("for (var "+e+" in "+c+") {\n"+i+"}\n")},a.JavaScript.controls_flow_statements=function(t){var r=""
...
case"CONTINUE":return r+"continue;\n"}throw Error("Unknown flow statement.")},a.JavaScript.math={},a.JavaScript.math_number=function(t){return t=+t.getFieldValue("NUM"),[t,t>=0?a.JavaScript.ORDER_ATOMIC:a.JavaScript.ORDER_UNARY_NEGATION]},a.JavaScript.math_arithmetic=function(t){var r={ADD:[" + ",a.JavaScript.ORDER_ADDITION],MINUS:[" - ",a.JavaScript.ORDER_SUBTRACTION],MULTIPLY:[" * ",a.JavaScript.ORDER_MULTIPLICATION],DIVIDE:[" / ",a.JavaScript.ORDER_DIVISION],POWER:[null,a.JavaScript.ORDER_NONE]}[t.getFieldValue("OP")],e=r[0]
r=r[1]
...
if("NEG"==r)return t=a.JavaScript.valueToCode(t,"NUM",a.JavaScript.ORDER_UNARY_NEGATION)||"0","-"==t[0]&&(t=" "+t),["-"+t,a.JavaScript.ORDER_UNARY_NEGATION]
...
case"NEGATIVE":i=r+" < 0"
break
case"DIVISIBLE_BY":t=a.JavaScript.valueToCode(t,"DIVISOR",a.JavaScript.ORDER_MODULUS)||"0",i=r+" % "+t+" == 0"}return[i,a.JavaScript.ORDER_EQUALITY]},a.JavaScript.math_change=function(t){var r=a.JavaScript.valueToCode(t,"DELTA",a.JavaScript.ORDER_ADDITION)||"0"
return t=a.JavaScript.variableDB_.getName(t.getFieldValue("VAR"),a.VARIABLE_CATEGORY_NAME),t+" = (typeof "+t+" == 'number' ? "+t+" : 0) + "+r+";\n"},a.JavaScript.math_round=a.JavaScript.math_single,a.JavaScript.math_trig=a.JavaScript.math_single,a.JavaScript.math_on_list=function(t){var r=t.getFieldValue("OP")
switch(r){case"SUM":t=a.JavaScript.valueToCode(t,"LIST",a.JavaScript.ORDER_MEMBER)||"[]",t+=".reduce(function(x, y) {return x + y;})"
break
case"MIN":t=a.JavaScript.valueToCode(t,"LIST",a.JavaScript.ORDER_NONE)||"[]",t="Math.min.apply(null, "+t+")"
break
case"MAX":t=a.JavaScript.valueToCode(t,"LIST",a.JavaScript.ORDER_NONE)||"[]",t="Math.max.apply(null, "+t+")"
break
case"AVERAGE":r=a.JavaScript.provideFunction_("mathMean",["function "+a.JavaScript.FUNCTION_NAME_PLACEHOLDER_+"(myList) {","  return myList.reduce(function(x, y) {return x + y;}) / myList.length;","}"]),t=a.JavaScript.valueToCode(t,"LIST",a.JavaScript.ORDER_NONE)||"[]",t=r+"("+t+")"
break
case"MEDIAN":r=a.JavaScript.provideFunction_("mathMedian",["function "+a.JavaScript.FUNCTION_NAME_PLACEHOLDER_+"(myList) {","  var localList = myList.filter(function (x) {return typeof x == 'number';});","  if (!localList.length) return null;","  localList.sort(function(a, b) {return b - a;});","  if (localList.length % 2 == 0) {","    return (localList[localList.length / 2 - 1] + localList[localList.length / 2]) / 2;","  } else {","    return localList[(localList.length - 1) / 2];","  }","}"]),t=a.JavaScript.valueToCode(t,"LIST",a.JavaScript.ORDER_NONE)||"[]",t=r+"("+t+")"
break
case"MODE":r=a.JavaScript.provideFunction_("mathModes",["function "+a.JavaScript.FUNCTION_NAME_PLACEHOLDER_+"(values) {","  var modes = [];","  var counts = [];","  var maxCount = 0;","  for (var i = 0; i < values.length; i++) {","    var value = values[i];","    var found = false;","    var thisCount;","    for (var j = 0; j < counts.length; j++) {","      if (counts[j][0] === value) {","        thisCount = ++counts[j][1];","        found = true;","        break;","      }","    }","    if (!found) {","      counts.push([value, 1]);","      thisCount = 1;","    }","    maxCount = Math.max(thisCount, maxCount);","  }","  for (var j = 0; j < counts.length; j++) {","    if (counts[j][1] == maxCount) {","        modes.push(counts[j][0]);","    }","  }","  return modes;","}"]),t=a.JavaScript.valueToCode(t,"LIST",a.JavaScript.ORDER_NONE)||"[]",t=r+"("+t+")"
break
case"STD_DEV":r=a.JavaScript.provideFunction_("mathStandardDeviation",["function "+a.JavaScript.FUNCTION_NAME_PLACEHOLDER_+"(numbers) {","  var n = numbers.length;","  if (!n) return null;","  var mean = numbers.reduce(function(x, y) {return x + y;}) / n;","  var variance = 0;","  for (var j = 0; j < n; j++) {","    variance += Math.pow(numbers[j] - mean, 2);","  }","  variance = variance / n;","  return Math.sqrt(variance);","}"]),t=a.JavaScript.valueToCode(t,"LIST",a.JavaScript.ORDER_NONE)||"[]",t=r+"("+t+")"
break
case"RANDOM":r=a.JavaScript.provideFunction_("mathRandomList",["function "+a.JavaScript.FUNCTION_NAME_PLACEHOLDER_+"(list) {","  var x = Math.floor(Math.random() * list.length);","  return list[x];","}"]),t=a.JavaScript.valueToCode(t,"LIST",a.JavaScript.ORDER_NONE)||"[]",t=r+"("+t+")"
break
default:throw Error("Unknown operator: "+r)}return[t,a.JavaScript.ORDER_FUNCTION_CALL]},a.JavaScript.math_modulo=function(t){var r=a.JavaScript.valueToCode(t,"DIVIDEND",a.JavaScript.ORDER_MODULUS)||"0"
return t=a.JavaScript.valueToCode(t,"DIVISOR",a.JavaScript.ORDER_MODULUS)||"0",[r+" % "+t,a.JavaScript.ORDER_MODULUS]},a.JavaScript.math_constrain=function(t){var r=a.JavaScript.valueToCode(t,"VALUE",a.JavaScript.ORDER_NONE)||"0",e=a.JavaScript.valueToCode(t,"LOW",a.JavaScript.ORDER_NONE)||"0"
return t=a.JavaScript.valueToCode(t,"HIGH",a.JavaScript.ORDER_NONE)||"Infinity",["Math.min(Math.max("+r+", "+e+"), "+t+")",a.JavaScript.ORDER_FUNCTION_CALL]},a.JavaScript.math_random_int=function(t){var r=a.JavaScript.valueToCode(t,"FROM",a.JavaScript.ORDER_NONE)||"0"
...
return a.JavaScript.STATEMENT_SUFFIX&&(r+=a.JavaScript.prefixLines(a.JavaScript.injectId(a.JavaScript.STATEMENT_SUFFIX,t),a.JavaScript.INDENT)),t.hasReturnValue_?(t=a.JavaScript.valueToCode(t,"VALUE",a.JavaScript.ORDER_NONE)||"null",r+=a.JavaScript.INDENT+"return "+t+";\n"):r+=a.JavaScript.INDENT+"return;\n",r+"}\n"},a.JavaScript.texts={},a.JavaScript.text=function(t){return[a.JavaScript.quote_(t.getFieldValue("TEXT")),a.JavaScript.ORDER_ATOMIC]},a.JavaScript.text_multiline=function(t){t=a.JavaScript.multiline_quote_(t.getFieldValue("TEXT"))
var r=-1!=t.indexOf("+")?a.JavaScript.ORDER_ADDITION:a.JavaScript.ORDER_ATOMIC
...
return t=a.JavaScript.valueToCode(t,"ADD1",a.JavaScript.ORDER_NONE)||"''",t=a.JavaScript.text.forceString_(r)[0]+" + "+a.JavaScript.text.forceString_(t)[0],[t,a.JavaScript.ORDER_ADDITION]
default:r=Array(t.itemCount_)
for(var e=0;e<t.itemCount_;e++)r[e]=a.JavaScript.valueToCode(t,"ADD"+e,a.JavaScript.ORDER_NONE)||"''"
return t="["+r.join(",")+"].join('')",[t,a.JavaScript.ORDER_FUNCTION_CALL]}},a.JavaScript.text_append=function(t){var r=a.JavaScript.variableDB_.getName(t.getFieldValue("VAR"),a.VARIABLE_CATEGORY_NAME)
...
case"FROM_START":return t=a.JavaScript.getAdjusted(t,"AT"),[e+".charAt("+t+")",a.JavaScript.ORDER_FUNCTION_CALL]
case"FROM_END":return t=a.JavaScript.getAdjusted(t,"AT",1,!0),[e+".slice("+t+").charAt(0)",a.JavaScript.ORDER_FUNCTION_CALL]
...
break
case"FROM_END":i=a.JavaScript.getAdjusted(t,"AT1",1,!1,a.JavaScript.ORDER_SUBTRACTION),i=c+".length - "+i
break
case"FIRST":i="0"
break
default:throw Error("Unhandled option (text_getSubstring).")}switch(e){case"FROM_START":t=a.JavaScript.getAdjusted(t,"AT2",1)
break
case"FROM_END":t=a.JavaScript.getAdjusted(t,"AT2",0,!1,a.JavaScript.ORDER_SUBTRACTION),t=c+".length - "+t
break
